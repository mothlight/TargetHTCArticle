...
\begin{figure}[!htbp]
\centering   
\fbox{\includegraphics[scale=0.32]{images/Sunbury1.png}}
\fbox{\includegraphics[scale=0.32]{images/Sunbury2.png}}
\\
\fbox{\includegraphics[scale=0.32]{images/Sunbury3.png}}
\fbox{\includegraphics[scale=0.32]{images/Sunbury4.png}}
...
\fbox{\includegraphics[scale=0.21]{images/SunburyDiff12.png}}
\fbox{\includegraphics[scale=0.21]{images/SunburyDiff13.png}}
\fbox{\includegraphics[scale=0.21]{images/SunburyDiff14.png}}
...
% this is absolute differences
%roof	-15.24	-187.44	-1195.27	
%road	-1.96	-61.43	-112.07	
%water	506.93	1213.35	1213.35	
%concrete	-1.63	-2.54	-8.83	
%tree	0.0	250.29	1079.54	
%grass	-417.92	-1969.61	-2464.8	
%irrigated	-70.16	757.39	1488.09	

% this is percent differences
%roof	-0.0188	-0.2318	-1.4785	
%road	-0.0024	-0.076	-0.1386	
%water	0.627	1.5009	1.5009	
%concrete	-0.002	-0.0031	-0.0109	
%tree	0.0	0.3096	1.3354	
%grass	-0.5169	-2.4364	-3.0489	
%irrigated	-0.0867	0.9369	1.8407	

%total percentages
%roof	12.9752	12.9563	12.7433	11.4966	
%road	7.6683	7.6659	7.5923	7.5296	
%water	0.0	0.627	1.5009	1.5009	
%concrete	2.6218	2.6198	2.6186	2.6109	
%tree	0.2399	0.2399	0.5495	1.5753	
%grass	73.5149	72.9979	71.0784	70.4659	
%irrigated	2.9797	2.8929	3.9166	4.8205	

% try masking out grasslands and try differences again
%AOI values

%318.14584404591056	183.69740089902018	0.0	89.25138433818161	6.043718504443156	75.08841841800485	29.77323379441851	
%318.6657635272028	183.78820413086623	0.0	89.17043468002791	6.043718504443156	81.50482734368451	22.82705181375537	
%311.6462512803366	180.70217679907205	0.0	88.54746783989569	13.859440828844283	42.16584142060522	65.07882183123168	
%284.6639096711316	179.7774483975391	0.0	88.0382977768607	40.20303209139302	12.725766194729001	96.59154586835834	
%roof	0.51	-6.49	-33.48	
%road	0.09	-2.99	-3.91	
%water	0.0	0.0	0.0	
%concrete	-0.08	-0.7	-1.21	
%tree	0.0	7.81	34.15	
%grass	6.41	-32.92	-62.36	
%irrigated	-6.94	35.3	66.81
	
%roof	0.0799	-0.9999	-5.151	
%road	0.0139	-0.4608	-0.603	
%water	0.0	0.0	0.0	
%concrete	-0.0124	-0.1082	-0.1866	
%tree	0.0	1.2024	5.2552	
%grass	0.9871	-5.065	-9.5942	
%irrigated	-1.0686	5.4316	10.2797	

%total percentages
%roof	48.9455	49.0255	47.9455	43.7944	
%road	28.2611	28.2751	27.8003	27.658	
%water	0.0	0.0	0.0	0.0	
%concrete	13.7309	13.7185	13.6226	13.5443	
%tree	0.9298	0.9298	2.1322	6.185	
%grass	11.552	12.5392	6.487	1.9578	
%irrigated	4.5804	3.5118	10.0121	14.8602	
...
\begin{figure}[!htbp]
\centering   
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/Sunbury1.png}}
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/Sunbury2.png}}
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/Sunbury3.png}}
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/Sunbury4.png}}
%\includegraphics[scale=0.35,trim = 0mm 0mm 155mm 96mm,clip]{images/SunburyDiff14_Small.png}
\\
\includegraphics[scale=0.43,trim = 0mm 0mm 155mm 96mm,clip]{images/SunburyDiff14_Small.png}
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/SunburyDiff12_Small.png}}
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/SunburyDiff13_Small.png}}
\fbox{\includegraphics[scale=1.9,trim = 124.5mm 70.5mm 98.9mm 76.5mm,clip]{images/SunburyDiff14_Small.png}}
\\ a) ~~~~~~~~~~~~~~~~~~~~~~~~~~~    b)   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  c) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  d)~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
%\includegraphics[scale=0.35,trim = 0mm 0mm 155mm 96mm,clip]{images/SunburyDiff14_Small.png}
%\\ a)      b)   c)
%\caption{\bf WSUD AOI scenarios differences. a) Difference between Current levels and No WSUD treatments. b) Difference between Future Targeted levels and No WSUD treatments. c) Difference between Maximal use of WSUD and No WSUD treatments. }    
% \label{fig:sunburyDiffScenariosAOI} 
%\end{figure} 
